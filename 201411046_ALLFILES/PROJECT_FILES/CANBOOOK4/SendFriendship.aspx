<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="SendFriendship.aspx.cs" Inherits="SendFriendship" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <asp:GridView ID="grdTeamOp" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="grdTeamOp_RowsCanceling" OnRowDeleting="grdTeamOp_RowsDeleting"  OnSelectedIndexChanged="Page_Load" Height="509px" Width="1007px">
            ...
            <ItemTemplate>
                <asp:Image ID="Image1" runat="server" Height="100px" ImageUrl='<%# Bind("ImagePath") %>' Widht="100px" />
            </ItemTemplate>
        </asp:TemplateField>
      ...
      <asp:TemplateField HeaderText="Name">
            ...
            <ItemStyle Font-Bold="True" Font-Names="Arial Black" HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                ...
                <asp:CommandField ButtonType="Image" DeleteImageUrl="~/Logos/add.png" HeaderText="Operation" ShowDeleteButton="True" ShowHeader="True"  CancelImageUrl="~/Logos/cancel.png" >
