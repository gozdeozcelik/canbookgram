<%@ Page Title="" EnableEventValidation="false"  Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
    ...
    <div class="w3-container w3-card w3-white w3-round w3-margin">
        ...
        <br />
               ...
               <div class="w3-container w3-card w3-white w3-round w3-margin">
                    ...
                    <asp:Image ID="photoim" height="70px" Width="70px" class="w3-left w3-circle w3-margin-right" ImageUrl='<%# FindImage(Eval("PostId")) %>' runat="server" />
